...
from Preprocessing.data_keys import steroid_reports_players
...
def separete_steroids_players(df:pd.DataFrame):
    steroid_p_url = steroid_reports_players.keys()
    steroid_idx = df[df["Full Name"].isin(steroid_p_url)].index
