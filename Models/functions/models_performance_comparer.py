...
def performance_comparer(X, y):
    ...
    label = ['dtg4','dte4', 'dte3','svm_r','svm_p', 'knn5', 'knn3', 'knn10','lr', 'rf10', 'rf5', 'nb']
    auc_s = [dtg4_metric[1], dte4_metric[1], dte3_metric[1], svmr_metric[1], svmp_metric[1], knn5_metric[1], knn3_metric[1], knn10_metric[1], lr_metric[1], rfg10_metric[1], rfg5_metric[1], nb_metric[1]]
    acc_s = [dtg4_metric[0], dte4_metric[0], dte3_metric[0], svmr_metric[0], svmp_metric[0], knn5_metric[0], knn3_metric[0], knn10_metric[0], lr_metric[0], rfg10_metric[0], rfg5_metric[0], nb_metric[0]]
    color = ['blue', 'violet', 'pink', 'green', 'black', 'yellow', 'cyan', 'orange', 'red', 'lime', 'peru', 'magenta']
